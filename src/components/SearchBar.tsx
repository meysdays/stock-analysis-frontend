        ...
        <div className="relative w-full max-w-md" ref={searchRef}>
            <div className="flex items-center">
                ...
                <input
                    ...
                    className="w-full px-6 pl-12 py-2 bg-gray-200/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all"
                />
            </div>
                        ...
                        results.map((stock) => (
                            ...
                            >
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-xs text-gray-500 truncate max-w-[200px]">{stock.name}</span>
                                </div>
