...
const Dividends = () => {
    ...
    const dividendStats = [
        { label: "Dividend Yield", value: formatPercent(stats?.dividend ? (stats.dividend / (stats.previous_close || 1)) * 100 : null) },
        { label: "Annual Dividend", value: formatCurrency(stats?.dividend) },
        { label: "Ex-Dividend Date", value: formatDate(stats?.ex_dividend_date) },
    ...
    const annualDiv = formatCurrency(stats?.dividend);
    const divYield = formatPercent(stats?.dividend ? (stats.dividend / (stats.previous_close || 1)) * 100 : null);
    const exDate = formatDate(stats?.ex_dividend_date);
        ...
        <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl  overflow-hidden mt-8 ">
                <div className="p-6 border-b border-gray-100 flex justify-between items-center">
                    <h2 className="text-xl font-bold text-slate-900">Dividend History</h2>
                    <p className="text-sm text-gray-500">Historical dividend payments and yield.</p>
                </div>
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-gray-50 border-b border-gray-100">
                            <tr>
                                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Ex-Dividend Date</th>
                                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider text-right">Dividend Amount</th>
            ...
            <div className="bg-white p-6 mt-8">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-bold text-slate-900">Dividend Charts</h2>
                ...
                <div className="relative border border-gray-100 rounded-xl p-6">
                    ...
                    <div className="h-[400px] w-full">
                        {isLoading ? (
                            ...
                            <div className="h-full w-full flex flex-col items-center justify-center text-gray-400 border border-dashed border-gray-200 rounded-xl bg-gray-50">
