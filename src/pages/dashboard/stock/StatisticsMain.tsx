      ...
      <div className="max-w-6xl mx-auto p-6 bg-surface-1 rounded-2xl border border-gray-100 shadow-sm">
        <div className="mb-12">
          ...
          <p className="text-secondary mt-2">
            Comprehensive financial and technical metrics for {data.name} (
            {data.symbol}).
          </p>
        </div>
        ...
        <Section title="Valuation">
          ...
          <StatRow label="EV/EBIT" value={data.ev_ebit} />
        ...
        <Section title="Balance Sheet">
          ...
          <StatRow
            ...
            value={data.shareholders_equity}
          />
