          ...
          <div className="col-span-12 lg:col-span-5 grid grid-cols-2 gap-x-10">
            <div className="space-y-0 text-[13px]">
              {metricsLeft.map((m, i) => (
                <div
                  key={i}
                  className="flex justify-between items-center py-2.5 border-b border-gray-100 last:border-0 h-[46px]"
                >
                  <span className="text-secondary font-medium underline decoration-gray-100 underline-offset-4 cursor-help">
                    {m.label}
                  </span>
                ...
                <div className="absolute inset-0 border border-dashed border-gray-100 rounded-xl flex items-center justify-center bg-background-1/30">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 text-xs mt-1">
                      Try a different stocks or check back later
                    </p>
                  </div>
                </div>
              )}
